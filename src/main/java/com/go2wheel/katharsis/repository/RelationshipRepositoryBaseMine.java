 ...
 * @param <D>
 */
public class RelationshipRepositoryBaseMine<T, D> extends RelationshipRepositoryBase<T, Long, D, Long> {
	
	private ResourceRegistry resourceRegistry;

	protected RelationshipRepositoryBaseMine(Class<T> sourceResourceClass, Class<D> targetResourceClass) {
