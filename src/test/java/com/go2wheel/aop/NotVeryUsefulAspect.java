...
public class NotVeryUsefulAspect {
	...
	@Pointcut("execution(* com.go2wheel.aop.AspectTargetTtt.beAdvised(..)) && args(c,..)")// the pointcut expression
//	@Pointcut("execution(* com.go2wheel.aop.AspectTargetTtt.*(..))")// the pointcut expression
