...
public abstract class MvcBase extends TaskBase {
    ...
    protected void contentTypeShoudBeApplicationJson(MvcResult result) {
        assertThat("content type should be: Content-Type:application/json;charset=utf-8", result.getResponse().getHeaderValue("Content-Type"), is("application/json;charset=utf-8"));
    }
